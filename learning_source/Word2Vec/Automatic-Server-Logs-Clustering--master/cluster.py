...
def tfidf_feature(documents, maxx, minn,documents_test):
    ...
    words = vectorizer.get_feature_names_out()  # Get all the words in the word bag model
...
def main():
    ...
    filename='./logs/train_set.txt'   #the filename of the train set on which prediction is to be done.
